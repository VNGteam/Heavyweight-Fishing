--[[
    ==================================================================
    🚀 IDENTICAL LOADER V2.8.6 - TẢI & BIÊN DỊCH SIÊU TỐC (CHỐNG TIMEOUT)
    ==================================================================
    Tính năng:
    - Nạp từ v2_bundle.lua (kiến trúc module, không bị lỗi too many local vars).
    ...
    - Tối ưu hóa mã nguồn trong bộ nhớ (In-Memory Shrink) giảm payload.
